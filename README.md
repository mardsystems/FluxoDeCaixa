...
Uma empresa de pagamentos deve ter a capacidade gerir pagamentos, recebimentos e encargos de seus clientes através de um fluxo de caixa.

## Requisitos

- Os clientes precisam de uma interface de lançamentos financeiros nas suas contas.
...
- A empresa precisa de uma consulta do fluxo de caixa do dia e dos próximos 30 dias, já com os lançamentos futuros.
...
- O cliente tem um limite para ficar negativo que não pode superar o valor de **R$ 20.000,00** no dia; caso ultrapasse não será possível fazer novos lançamentos no dia e qualquer tentativa de lançamento deve falhar e o motivo deve ser informado.
- Caso o saldo da conta esteja negativo sobre o mesmo incidem juros de **0,83%** ao dia.
